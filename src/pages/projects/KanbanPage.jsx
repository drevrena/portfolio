    ...
    return <div className="bg-slate-900 w-full min-h-screen">
        <div className="flex flex-col py-8 container">
            ...
            <div className="lg:bg-slate-800 lg:rounded-lg lg:p-8 lg:my-8 lg:flex items-center justify-between gap-16 mt-12">
                <img className="lg:w-1/2 mb-12" src="../assets/images/kanban.webp" alt="Project Homepage mockup"/>
                <div>
                    <h2 className="text-secondary text-xl font-bold mb-4">What's the goal?</h2>
                    <p>This project started as a challenge to myself to create a Web Application
                        that uses all of the skills and design patterns that I learnt from past projects and
                        courses.
                    </p>
                    <div className="flex gap-4 mt-4">
                        <a href="https://github.com/drevrena/kanban" target="_blank">
                        ...
                        <a href="https://kanban-two-blond.vercel.app/" target="_blank">
            ...
            <p>
            To implement the authentication system and save data on a solid backend that allows me to perform CRUD operations, Firebase was the best choice for me.
            <br/>
            All user data is saved using Firestore. Each user can have multiple boards that contain multiple tasks and subtasks.
            <br/>
            Tailwind.css was used to help with CSS styles.
            </p>
            <h3 className="text-secondary text-lg font-bold my-4">What I learned from it?</h3>
            <p>
                I learned a lot about managing global states, got a good grasp on how the Firebase environment
                works by playing with some of its features and learned how some popular react libraries
                like react-beautiful-dnd, react-modal and react-router work.
            </p>
        </div>
    </div>
}
