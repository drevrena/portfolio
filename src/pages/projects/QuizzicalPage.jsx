    ...
    return <div className="bg-slate-900 w-full min-h-screen">
        <div className="flex flex-col py-8 container">
            ...
            <div className="lg:bg-slate-800 lg:rounded-lg lg:p-8 lg:my-8 lg:flex items-center justify-between gap-16 mt-12">
                <img className="lg:w-1/2 mb-12" src="../assets/images/quizzical.webp" alt="Project Homepage mockup"/>
                <div>
                    <h2 className="text-secondary text-xl font-bold mb-4">What's the goal?</h2>
                    <p>The main goal of this project was to learn and consolidate the basics of web development and React.
                        I focused on learning how the react hooks work, what calling an external API means and how I can use 
                        conditional rendering to create a Single Page Application.
                    </p>
                    <div className="flex gap-4 mt-4">
                        <a href="https://github.com/drevrena/quizzical" target="_blank">
                        ...
                        <a href="https://quizzical-lovat.vercel.app/" target="_blank">
            ...
            <p>
                Technology-wise, this project used some basic React features like useState and useEffect Hooks and
                HTML styled with some basic CSS rules.
            </p>
            <h3 className="text-secondary text-lg font-bold my-4">What I learned from it?</h3>
            <p>
                I learned the very basics of React, introducing myself to the concept of React hooks and its features.
                That allowed me to practice very common fragments of code such as the .map() method, ES6 spread operator,
                ternary operator and how to use the fetch API to query a remote API.
            </p>
        </div>
    </div>
}
